    ...
    <div style={{ background: "black" }}>
      ...
      <h3>
        <div>
          <img
            style={{ marginLeft: "2%" }}
            src="https://images.unsplash.com/flagged/photo-1584036561584-b03c19da874c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1489&q=80"
          />
        </div>
        <article>
        ...
        <iframe
          style={{ width: "60%", height: "80vh", marginLeft: "10%" }}
        ...
        <div className="cards">
          <p>
            <h4>
              ...
              degrees DOES NOT prevent the coronavirus disease
            </h4>
